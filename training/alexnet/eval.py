...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('alexnet_trained.pth'))

    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    model.to(device)
    
    preds, targets, confusion_matrix = eval_model(model, dataloaders)
    np.save('/home/user/git/vocalpy/training/alexnet/preds', preds)
    np.save('/home/user/git/vocalpy/training/alexnet/targets', targets)
    np.save('/home/user/git/vocalpy/training/alexnet/confusion', confusion_matrix)