...
def parallel_audio_processing(chunk):
    ...
    if args.plot:
        ...
        plt.title('Pxx')
        plt.subplot(312)
        plt.pcolormesh(t[print_range_a:print_range_b], f, grain[:, print_range_a:print_range_b], cmap='gray')
        plt.title('grain')
        plt.subplot(313)
        plt.pcolormesh(t[print_range_a:print_range_b], f, B_masked[:, print_range_a:print_range_b], cmap='gray')
        plt.title('B_masked')
        plt.show()
        del B_masked
    del Pxx_scaled
