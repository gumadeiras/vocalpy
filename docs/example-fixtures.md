...
- Neural segmentation masks pre-generated by [SqueakOut](https://github.com/gumadeiras/squeakout), stored under `cnn_mask/`
...
- **Neural masks:** `examples/audios/mouse_1_outputs/cnn_mask/` and `examples/audios/mouse_2_outputs/cnn_mask/`
